  ...
  stdenv.mkDerivation rec {
    ...
    installPhase = ''
      ...
      makeWrapper ${jre8}/bin/java $out/bin/$exec \
        ...
        -jar $out/share/java/${module}-${version}.jar -cp $out/share/java/Furniture.jar:$out/share/java/Textures.jar:$out/share/java/Help.jar -d${toString stdenv.hostPlatform.parsed.cpu.bits}"
