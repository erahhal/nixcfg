...
echo '  - Make sure to update dependent repos to add host, e.g. nixcfg-secrets'
echo '  - You make need to run `nix flake update` on the host for a system that has never been installed before.'
