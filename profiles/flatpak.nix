    ...
    overrides = {
      "com.valvesoftware.Steam" = {
        ...
        Environment = {
          ...
          # Override inherited value from niri env — "nvidia" crashes CEF GPU process
          # in flatpak with NVIDIA drivers >= 545 (flathub #1198)
  ...
  systemd.services.steamvr-flatpak-fix = {
    ...
    script = ''
      for user_home in /home/*; do
        # Check both flatpak sandbox path and host path (when filesystem override is used)
        for STEAMVR_DIR in \
